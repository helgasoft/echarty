...
A collection of charts with their **source code** showing usage of
*echarty*. Some Live Demos are hosted on
[RPubs](https://rpubs.com/echarty).  
...
`?ec.examples` to see them.

  

### Single-page web hosting

Edit R-code and run charts inside a web page - [Live
Demo](https://helgasoft.github.io/echarty/test/coder.html)

Real-Time Data charts with echarty - [Live
Demo](https://helgasoft.github.io/echarty/test/realTime.html)  
  

### Data models

how to store data in echarty - [Live
Demo](https://rpubs.com/echarty/data-models) with code  
...
play with the [Live Demo](https://rpubs.com/echarty/crosstalk), code
included  
...
Check out also the [World Map demo](https://rpubs.com/echarty/crossmap),
using ECharts map.  
...
dependencies - [source
code](https://gist.github.com/helgasoft/121d7d3ff7d292990c3e05cfc1cbf24b).  
...
Inspired by [Julia Silge’s
article](https://juliasilge.com/blog/giant-pumpkins/). ECharts advantage
over ggplot is interactivity - zoom brush and tooltips.  
...
Statistical tools plugin in echarty       [Live
Demo](https://rpubs.com/echarty/ecStat) with code
[![dow](img%2Fcb-cluster.png)](https://rpubs.com/echarty/ecStat)  
  

### Morphing charts

Animated transitions between charts       [Live
Demo](https://rpubs.com/echarty/morph) with code
[![morph](img%2Fmorph.w.png)](https://rpubs.com/echarty/morph)  
...
Demo](https://rpubs.com/echarty/inet)  
[![world_speed](img%2Fcb-speed.png)](https://rpubs.com/echarty/inet)  
  

### 3D Globe

Interactive 3D application with ECharts [3D
Globe](https://echarts.apache.org/examples/en/index.html#chart-type-globe)
      [Live Demo](https://rpubs.com/echarty/satellites)  
[![3D
Globe](img%2Fsattxt.600.gif)](https://rpubs.com/echarty/satellites)

🔻 Features

- real-time satellite data filtered by altitude
- charts: scatter3D for satellite location, bar3D for beams and lines3D
  for tracks
- controls: hover icons, timeline play/stop, animations toggle,
  zoom/rotate globe
- published as [live demo](https://rpubs.com/echarty/satellites)
...
use for history, schedules, Gantt, etc. See also [live
calendar](https://rpubs.com/echarty/paris-art)  
